  ...
  <div class="content-wrapper" :class='{active: this.$store.state.isActive}'>
    ...
    <nav>
      <ul>
        ...
        <li class="li3" v-if="currentUserData.postId != 'p005'"><router-link active-class="active" to="/tablesInfo">Столики</router-link></li>
        <li class="li4"><router-link active-class="active" to="/feedBack">Відгуки</router-link></li>
        <li class="li5" v-if="currentUserData.postId != 'p005' && currentUserData.postId != 'p004'"><router-link active-class="active" to="/purchases">Закупки</router-link></li>
        <li class="li6" v-if="currentUserData.postId != 'p005' && currentUserData.postId != 'p002' && currentUserData.postId != 'p003' && currentUserData.postId != 'p004'"><router-link active-class="active" to="/reports">Звіти</router-link></li>
        <li class="li7" v-if="currentUserData.postId != 'p005' && currentUserData.postId != 'p002' && currentUserData.postId != 'p003' && currentUserData.postId != 'p004'"><router-link active-class="active" to="/analitics">Аналітика</router-link></li>
        <li class="li8" v-if="currentUserData.postId != 'p005' && currentUserData.postId != 'p002' && currentUserData.postId != 'p003' && currentUserData.postId != 'p004'"><router-link active-class="active" to="/usersList">Користувачі</router-link></li>
      </ul>
    </nav>
